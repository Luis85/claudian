...
- **`description` = what it does + WHEN to use it**, third person, keyword-rich — *not* a workflow summary (a workflow summary makes the agent follow the description instead of reading the skill).
