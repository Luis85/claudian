...
export const CURSOR_PROVIDER_ICON: ProviderIconSvg = {
  viewBox: '0 0 24 24',
  path: 'M11.996 1.5a1.5 1.5 0 0 0-.75.2L2.75 6.59a1.5 1.5 0 0 0-.75 1.3v8.22a1.5 1.5 0 0 0 .75 1.3l8.496 4.89a1.5 1.5 0 0 0 1.5 0l8.496-4.89a1.5 1.5 0 0 0 .75-1.3V7.89a1.5 1.5 0 0 0-.75-1.3l-8.496-4.89a1.5 1.5 0 0 0-.75-.2Zm0 2.04 7.5 4.32-7.5 4.32-7.5-4.32 7.5-4.32ZM4 9.6l7 4.03v8.06l-7-4.03V9.6Zm9 12.09v-8.06l7-4.03v8.06l-7 4.03Z',
};
